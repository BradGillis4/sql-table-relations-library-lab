INSERT INTO series (title, auhtour_id, subgenre_id) VALUES 
("ASOIAF", 1, 1),
("LOTR", 2, 2);

-- INSERT INTO subgenres (name) VALUES ( "fantasy"), ("high-fantasy");

-- INSERT INTO authors (name) VALUES ("George R. R. Martin"), ("J.R.R Tolkin");

-- INSERT INTO ("Game of Thrones", 1996, 1), ("A Clash of Kings", 1998, 1), ("A Storm of Swords", 2000, 1), 
-- ("Fellowship", 1950, 2), ("Two Towers", 1951, 2), ("Return", 1952, 2);

-- INSERT INTO characters (name, motto, species, author_id) VALUES 
-- ("Lady", "Woo", "direwolf", 1), ("Tyrion Lannister", "A Lannister always pays his debts", "human", 1), 
-- ("Daenerys Targaryen", "If I look back I am lost", "human", 1), ("Eddard Stark", "Winter is coming", "human", 1),
-- ("Frodo", "The Ring SAM", "hobbit", 2), ("Sam", "Mr.Frodo, PO-TA-TOES", "hobbit", 2),
-- ("Merry", "You have any pipe-weed, Pip?", "hobbit", 2), ("Pip", "Of course, Mary", "hobbit", 2);
...
("Game of Thrones", 1996, 1), ("A Clash of Kings", 1998, 1), ("A Storm of Swords", 2000, 1), 
("First Book", 2002, 2), ("Second Book", 2003, 2), ("Third Book", 2005, 2);
